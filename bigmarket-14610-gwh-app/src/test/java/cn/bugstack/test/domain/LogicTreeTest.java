 ...
 * @description 测试规则树  --测试预期；rule_lock 放行、rule_stock 拦截、rule_luck_award 放行，获得最后的结果。
 **/
...
public class LogicTreeTest {
    ...
    public void test_tree_rule() {
        ...
        DefaultTreeFactory.StrategyAwardData data = treeEngine.process("gwh", 100001L, 100);
